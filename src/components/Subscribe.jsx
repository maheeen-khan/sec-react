...
import send from '../assets/Group 77.png'
const Subscribe = () => {
    return (
        <>
            <Divider orientation="right" style={{ border: '3px solid grey', border: 'none' }}>
                <img src={send} alt="" width={40} />
            </Divider>
            <div className="container-fluid subs">

                <div className="container p-lg-5">

                    <h3 className='text-center py-4 p-lg-5 p-md-5'>

                        Subscribe to get information, latest news and other interesting offers about Jadoo
                    </h3>
                    <div className="inp mt-3 pb-4">
