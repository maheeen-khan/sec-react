    ...
    return (
        <>
            <div className="container px-3 pt-5 mt-3">
                <div className="row">
                    <div className="col-lg-2 col-md-2 col-md-2 bot1 align-content-center">
                    ...
                    <div className="col-lg-2 col-md-2 col-md-2 bot align-content-center">
                    ...
                    <div className="col-lg-2 col-md-2 col-md-2 bot3 align-content-center">
                        <ul style={{ color: 'rgb(94, 94, 94)' }}>
